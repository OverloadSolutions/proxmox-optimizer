...
## Pretty MOTD BANNER
  if ! grep -q https "/etc/motd" ; then
    cat << 'EOF' > /etc/motd.new
	   This system is optimised by:            https://overloadsolutions.net
   ___                      _                   _     ___         _          _     _                    
  / _ \  __ __  ___   _ _  | |  ___   __ _   __| |   / __|  ___  | |  _  _  | |_  (_)  ___   _ _    ___ 
 | (_) | \ V / / -_) | '_| | | / _ \ / _` | / _` |   \__ \ / _ \ | | | || | |  _| | | / _ \ | ' \  (_-< 
  \___/   \_/  \___| |_|   |_| \___/ \__,_| \__,_|   |___/ \___/ |_|  \_,_|  \__| |_| \___/ |_||_| /__/ 
